...
Tooltip.prototype.draw = function() {
	...
	// Adjusts overflow to right
	if (ne.x > 710) { // IMPORTANT! Calculated by: map length - tooltip length
		ne.x -= 130;
	}
	
	// Adjusts overflow on bottom
	if (ne.x > 600 && (ne.y > 350)) { // IMPORTANT! Calculated by: map length - tooltip length
		ne.x += 15;
		ne.y -= 35;
	}
